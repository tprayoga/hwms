...
exports.FeedModule = FeedModule = __decorate([
    (0, common_1.Module)({
        ...
        providers: [feed_service_1.FeedService, team_resolver_service_1.TeamResolverService],
        exports: [feed_service_1.FeedService, team_resolver_service_1.TeamResolverService],
    })
], FeedModule);
